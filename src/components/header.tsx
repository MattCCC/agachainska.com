...
const LinkItem = styled(Link)((props: LinkProps) => [
    ...
    `,
    props.currentLocation === props.to &&
        css`
...
export function Header({ ...props }: Props) {
    ...
    return (
        <HeaderTag {...props}>
            ...
            <Navigation>
                <LinkItem to="/work/re-max" currentLocation={location.pathname}>
                    <Translate id="header.link.work" />
                </LinkItem>
                <LinkItem to="/about" currentLocation={location.pathname}>
                    <Translate id="header.link.about" />
                </LinkItem>
                <LinkItem to="/contact" currentLocation={location.pathname}>
